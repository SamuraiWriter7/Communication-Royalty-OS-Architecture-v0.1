...
TARGETS = [
    ...
    },
    {
        ...
        "schema": REPO_ROOT / "schemas" / "policy-evaluation.schema.json",
        "example": REPO_ROOT / "examples" / "policy-evaluation.example.yaml",
    },
    {
        "name": "Review Record",
        "schema": REPO_ROOT / "schemas" / "review-record.schema.json",
        "example": REPO_ROOT / "examples" / "review-record.example.yaml",
    },
]
